...
We can compute the exact time shift, it requires some work with functional programming.
Finding for which time values (in seconds) the density is the highest and convert it back to a `time`
